...
class FundsIndia extends StatefulWidget {
 // const FundsIndia({Key? key}) : super(key: key);
String InvestmentType;
FundsIndia({required this.InvestmentType});
  @override
  State<FundsIndia> createState() => _FundsIndiaState();
}

class _FundsIndiaState extends State<FundsIndia> {
