...
//   int _currentPageIndex = 0;
  ...
  //     Navigator.push(
  //       context,
  //       MaterialPageRoute(builder: (context) => OnBoardScreen(this.from, this.type,)),
  //     );
  //   }
  // }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Center(
            child: Image(
              image: AssetImage("images/WhatsApp Image 2023-07-17 at 6.12.10 PM (1).jpeg"),
              width: 600,
            ...
            child: Column(
              ...
              children: [
                Flexible(
                 ...
                 SizedBox(height: 12),
                Text(
                  "We bring in the options for covering\n almost every aspect of your and your\n loved one's lines.",
                  style: TextStyle(
                    color: greyColor,
                    fontSize: 16,
                ...
                child: IconButton(
                 // onPressed: _nextPage,
                   onPressed: () {
                      Navigator.push(
                             context,
                   MaterialPageRoute(builder: (context) => OnBoardScreen(from, type,)),
                          );
