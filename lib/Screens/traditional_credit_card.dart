...
class TraditionalCreditCards extends StatefulWidget {
  const TraditionalCreditCards({Key? key}) : super(key: key);

  @override
  State<TraditionalCreditCards> createState() => _TraditionalCreditCardsState();
}

class _TraditionalCreditCardsState extends State<TraditionalCreditCards> {
...
/*      HomePageList(
  ...
  HomePageList(
          id: "8", name: "HDFC Bank", image: "images/hdfc-bank-limited.png", type: 'credit_card'),
  HomePageList(
          id: "8", name: "ICICI Bank", image: "images/icicibank.png", type: 'credit_card'),
      HomePageList(
          id: "8", name: "Citi Bank (Pune & Mumbai)", image: "images/Citi.png", type: 'credit_card'),
  HomePageList(
          id: "8", name: "Bajaj RBL", image: "images/RBL_logo_262.png", type: 'credit_card'),
  HomePageList(
          id: "8", name: "Axis Bank", image: "images/axis.png", type: 'credit_card'),
  HomePageList(
          id: "8", name: "Standard Chartered", image: "images/charted.png", type: 'credit_card'),
  HomePageList(
          id: "8", name: "SBI Bank", image: "images/sbi.png", type: 'credit_card'),
  HomePageList(
          id: "8", name: "AU Finance", image: "images/au.png", type: 'credit_card'),
HomePageList(
          id: "8", name: "Yes Bank", image: "images/yesbank.png", type: 'credit_card'),
HomePageList(
          id: "8", name: "IndusInd", image: "images/indusind-bank--600.png", type: 'credit_card'),
