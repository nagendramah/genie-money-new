...
class AlternativeInvestment extends StatefulWidget {
 // const AlternativeInvestment({Key? key}) : super(key: key);
String InvestmentType;
AlternativeInvestment({required this.InvestmentType});
  @override
  State<AlternativeInvestment> createState() => _AlternativeInvestmentState();
}

class _AlternativeInvestmentState extends State<AlternativeInvestment> {
  ...
  void initState() {
    ...
    // }
   // else 
    if(widget.InvestmentType=="Alternative investment"){
      homepageList = [
        HomePageList(
            id: "112", name: "GILD Card", image: "images/Gild.jpg",type: "Alternative investment"),
