...
CreditLineResponse creditLineResponseFromJson(String str) => CreditLineResponse.fromJson(json.decode(str));

String creditLineResponseToJson(CreditLineResponse data) => json.encode(data.toJson());
...
class CreditLineResponse {
  ...
  factory CreditLineResponse.fromJson(Map<String, dynamic> json) => CreditLineResponse(
    status: json["status"],
